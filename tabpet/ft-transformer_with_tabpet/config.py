"""
Configuration file for the FT-Transformer with Tab-PET experiment
"""
...
K_FIRST_DEFAULT = 3 # using auto k selection algorithm first
K_LAST_DEFAULT = 3 # using auto k selection algorithm first
...
EXPERIMENT_CONFIG = {
    ...
    # 'pe_alphas': [0.0, 1.0], # for quick run
